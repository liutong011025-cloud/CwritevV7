...
3. CRITICAL: You MUST mark the COMPLETE phrase or sentence that contains the error, NOT just individual words.
   - Mark the ENTIRE grammatically incorrect phrase or sentence that needs to be corrected
   - Include ALL words in the phrase/sentence that are part of the error context
   - For example: If "She go to the library" should be "She goes to the library", mark the ENTIRE phrase "She go to the library"
   - For example: If "I are happy" should be "I am happy", mark "I are happy" (the complete phrase)
   - For example: If "Nicole feel very excited and she want" should be "Nicole feels very excited and she wants", mark the ENTIRE phrase "Nicole feel very excited and she want"
   - The goal is to highlight and replace complete phrases/sentences, not individual words
4. original MUST be the EXACT text from the original content at positions [start:end], including all spaces and punctuation
5. corrected is the suggested correction - the COMPLETE corrected phrase/sentence, NO leading or trailing spaces
6. issue is a brief explanation (e.g., "Subject-verb agreement", "Missing comma", "Spelling error")
7. Be precise with character positions - count every character including spaces, newlines, and punctuation
8. Ensure the corrected text makes the sentence grammatically correct and fluent
9. If there are no errors, return an empty array: []
10. Return ONLY the JSON array, no other text before or after
...
[
  ...
  },
  {
    "start": 120,
    "end": 145,
    "original": "She go to the library",
    "corrected": "She goes to the library",
    "issue": "Subject-verb agreement error"
  }
]`
