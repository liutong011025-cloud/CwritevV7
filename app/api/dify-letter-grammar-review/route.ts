...
3. original MUST be the EXACT text from the original content at positions [start:end], including any spaces if they are part of the error
4. corrected is the suggested correction (without leading/trailing spaces unless the error includes spaces)
5. issue is a brief explanation (e.g., "Subject-verb agreement", "Missing comma", "Spelling error")
6. IMPORTANT: Mark the COMPLETE error word/phrase. If a word is split incorrectly (e.g., "re ading" should be "reading"), mark the entire incorrect portion including spaces. If a word is misspelled, mark only that word.
