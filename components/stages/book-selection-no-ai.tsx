      ...
      <div className="max-w-4xl mx-auto relative z-10" style={{ paddingTop: '120px', paddingBottom: '120px' }}>
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-black mb-4 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 bg-clip-text text-transparent">
            {language === "zh" ? "選擇你的書" : "Choose Your Book"}
          </h1>
          ...
          <p className="text-base text-gray-500">
            {language === "zh" ? "輸入你想評論的書名" : "Enter the title of the book you'd like to review"}
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <p className="mt-3 text-sm text-gray-500 text-center">
                {language === "zh" ? "輸入你想寫的書名" : "Type the name of the book you want to write about"}
              </p>
            </div>
