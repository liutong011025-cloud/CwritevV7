...
const getQuestions = (language: Language = "en"): Question[] => {
  const translations = {
    ...
    zh: {
      q1: "哪樣聽起來最有趣去寫？",
      q1a: "告訴朋友今日發生了什麼（我喜歡分享真實的事）。",
      q1b: "講一本書是好棒還是無聊與為什麼（我喜歡發表意見）。",
      q1c: "編造一個有酷角色的魔法冒險（我喜歡想像）。",
      q2: "你更想為誰寫？",
      q2a: "朋友、父母或老師（我認識的人）。",
      q2b: "可能會讀我喜歡的書的小朋友（想要建議的人）。",
      q2c: "任何喜歡冒險或驚喜的人（我故事的觀眾）。",
      q3: "寫作時你想在哪方面變得更好？",
      q3a: "表達我的感受與保持友好（像朋友一樣寫）。",
      q3b: "用例子解釋為什麼某樣東西好或不好（提供理由）。",
      q3c: "創造情節、角色與驚喜（建立整個世界）。",
      q4: "你想你的作品有多長？",
      q4a: "簡短而甜蜜——只是幾段（快速完成）。",
      q4b: "稍長但集中——講為什麼我喜歡一本書（清晰部分）。",
      q4c: "更長，有場景與可能的章節想法（大想像力）。",
      q5: "選擇聽起來最好的提示：",
      q5a: "\"你好！猜猜我今日做了什麼？\"",
      q5b: "\"這本書好棒因為…\"",
      q5c: "\"從前，一條龍失去了它的顏色…\"",
...
const getRecommendations = (language: Language = "en") => {
  const translations = {
    ...
    zh: {
      storyGoal: "練習想像力、角色塑造與情節。",
      storyTips: [
        "用強有力的開場白開始（例如，「雨說話的那天，一切都改變了…」）。",
        "創造一個主要角色與一個它必須解決的問題。",
        "寫3個短場景：開始、中間、結尾。"
      ],
      storyPrompt: "從前，一隻小貓發現了一張發光的地圖…",
      bookGoal: "練習用理由與例子發表意見。",
      bookTips: [
        "先講你是否喜歡這本書與為什麼。",
        "從書中提供2-3個例子支持你的意見。",
        "以你認為誰會喜歡這本書結束。"
...
const uiTranslations = {
  ...
  zh: {
    title: "開始制定計劃",
    subtitle: "讓我們為你找到完美的寫作類型！",
    back: "← 返回",
    questionOf: "問題",
    of: "共",
    orWrite: "或者你只是想寫...",
    shortLength: "簡短而甜蜜——只是幾段",
    mediumLength: "稍長但集中——清晰部分",
    longLength: "更長，有場景與可能的章節想法",
    storyStructure: ["開始：介紹你的角色與設定", "中間：展示問題或冒險", "結尾：解決問題或完成冒險"],
    bookStructure: ["介紹：哪本書與你的整體意見", "正文：書中的理由與例子", "結論：誰會喜歡這本書"],
    letterStructure: ["問候：向讀者問好", "正文：分享發生了什麼與你的感受", "結尾：問問題或送上祝福"],
  },
}
